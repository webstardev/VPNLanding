<template>
  <div class="container-fluid staff">
    <div class="container">
      ...
      <div class="row">
        <div class="col-12 col-md-6 col-lg-4 mx-auto pb-5">
          <div class="col-10 col-md-12 d-flex pb-5">
        ...
        <div class="col-12 col-md-6 col-lg-4 mx-auto pb-5">
          ...
          <div class="staff-words">
            “My searches are relevant and the interface is easy to use. I am
            more and more concerned with my privacy online and I feel like DS
            Defender truly understands this need for protection. I have my whole
            family using this app now.”
          </div>
        </div>
