  ...
  <div class="privacy-page">
    ...
    <b-container>
      <div class="small-container section wp-content">
        <div class="text-left">
          <h2 class="mb-4 mt-4">Introduction</h2>
          <p>
            BLINDCUT, LLC (the “Company” or “We”) respects your privacy and we
            are committed to protecting it through our compliance with this
            policy.
            <br />
          </p>
          <p>
            This policy describes the types of information we collect when you
            use our browser, "DS Defender", visit our website
            (https://www.dsdefender.com), or use any of our applications (our
            “Products”), as well as our practices for collecting, using,
            maintaining, protecting, and disclosing that information.
          </p>
          <p>
            This policy applies to the minimal, necessary information we may
            collect:
          </p>
          <ul class="nobull">
            <li>- Through our Products.</li>
            <li>
              - In email, text, and other electronic messages that you initiate
              between you and our Products.
            </li>
            <li>
              - Through mobile and desktop applications you download through any
              of our Products.
            </li>
          </ul>
          ...
          <ul class="nobull">
            <li>
              - by and through any other means, including on any other website
              operated by the Company (including our affiliates and
              subsidiaries);
            </li>
          </ul>
          <p>
            This policy applies to the minimal, necessary information we
            collect:
          </p>
          <ul class="nobull">
            <li>- Through our Products.</li>
          ...
          <ul class="nobull">
            <li>
              - by and through any other means, including on any other website
              operated by the Company or any third party (including our
            ...
            <li>
              ...
              advertising) that may link to or be accessible from our Products.
            </li>
          </ul>
          <p>
            ...
            to use our Products. By accessing or using our Products, you agree
            to this privacy policy. This policy may change from time to time.
            Your continued use of our Products after we make changes shall be
            deemed to be acceptance of those changes, so please check the policy
            periodically for updates.
          </p>
          <h3>Children Under the Age of 13</h3>
          <p>
            Our Products are not intended for children under 13 years of age. No
            one under age 13 may provide any information through our Products.
            We do not knowingly collect personal information from children under
            13. If you are under 13, do not use or provide any information
            through our Products or make any purchases through our Products. If
            ...
            under13@blindcut.com.
          </p>
          <h3>The Information We May Collect and How We Collect It</h3>
          <p>
            The only “personal” information that we may unintentionally collect
            is the following:
          </p>
          <ul class="nobull">
            <li>
            ...
            <li>
              ...
              use to access our Products and usage details.
            </li>
          </ul>
          <h3>We DO NOT collect any of the following personal information:</h3>
          <ul class="nobull">
            <li>
              - Your name, postal address, telephone number or any other
              identifier outside your email address.
            </li>
            <li>
          ...
          <p>
            The only other information we may collect on or through our Products
            includes:
          </p>
          <ul class="nobull">
            <li>
              - Information that you may provide by filling in forms on or
              through our Products. This includes information provided at the
              time of registering to use our Products, and subscribing to our
          ...
          <p>
            ...
            Products, we may use automatic data collection technologies to
          ...
          <p>
            ...
            helps us to improve our Products and to deliver a better and more
            personalized service, enabling us to estimate our audience size and
            usage patterns.
          </p>
          <h3>How We Use Information:</h3>
          <p>
            We use information that we collect, including any personal
            information:
          </p>
          <ul class="nobull">
            <li>- To present our Products and its contents to you.</li>
            <li>
            ...
            <li>
              ...
              or provide though those Products.
            </li>
            <li>
          ...
          <p>We may disclose any information that we receive:</p>
          <ul class="nobull">
            <li>
            ...
            <li>
              ...
              the rights, property, or safety of our Company, our customers, or
              others.
            </li>
          </ul>
          ...
          <p>
            ...
            privacy practices, contact us at: help@blindcut.com
          </p>
        </div>
 <!-- <SocialShare :data="sharing" /> -->
      </div>
    </b-container>
  </div>
</template>
